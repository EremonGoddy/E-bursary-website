...
const DisclosureDetails = () => {
  ...
  // On mount, check if user has already filled disclosure details (session/localstorage + DB check)
  useEffect(() => {
    ...
    // If already submitted disclosure details, redirect to DocumentUpload
    if (localStorage.getItem('disclosureDetailsCompleted') === 'true') {
