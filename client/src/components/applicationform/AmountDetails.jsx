...
<h2 className="text-lg font-semibold mb-6 text-center text-[#14213d]">Amounts Applied</h2>
<form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
<div>
<label htmlFor="payablewords" className="block font-medium mb-2 text-[#14213d]">Total amounts payable in words</label>
<input
type="text"
id="payablewords"
name="payablewords"
...
<div>
<label htmlFor="payablefigures" className="block font-medium mb-2 text-[#14213d]">Total amounts payable in figures</label>
<input
type="number"
id="payablefigures"
name="payablefigures"
...
<div>
<label htmlFor="outstandingwords" className="block font-medium mb-2 text-[#14213d]">Outstanding balance in words</label>
<input
type="text"
id="outstandingwords"
...
<div>
<label htmlFor="outstandingfigures" className="block font-medium mb-2 text-[#14213d]">Outstanding balance in figures</label>
<input
type="number"
...
<div>
<label htmlFor="accountname" className="block font-medium mb-2 text-[#14213d]">School account name</label>
<input
type="text"
id="accountname"
name="accountname"
...
<div>
<label htmlFor="accountnumber" className="block font-medium mb-2 text-[#14213d]">School account number</label>
<input
type="number"
id="accountnumber"
name="accountnumber"
...
className="bg-[#14213d] text-white cursor-pointer px-10 py-2 font-bold min-w-[100px] md:min-w-[160px] rounded focus:ring-2 focus:ring-indigo-600 transition duration-200"
>
Next
</button>
</div>
