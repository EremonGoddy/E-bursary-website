...
const villages = {
// Turkana Central wards
"Kanamkemer": ["Kanamkemer", "Nawoitorong/Lolupe", "Naotin", "Loturerei"],
"Kerio Delta": ["Lorengelup", "Nadoto", "Kerio", "Nakurio", "Kangirisae"],
"Kang’atotha": ["Eliye", "Lomopus", "Namukuse", "Lochor a Ikeny"],
"Kalokol": ["Kapua", "Kalokol Township", "Namadak", "Nabwel Ekorot"],
"Lodwar Township": ["Lodwar Town", "Nakwamekwi", "Nkapetet", "Kakwanyang", "Kawalase"],
   
//Turkana North examples 
"Kaeris": ["Kaeris Village", "Kangakipur", "Mlima-Tatu","Nakitoe-kakumon", "Nadunga", "Kanukurudio"], 
"Kaaleng/Kaikor": ["Kaikor", "Kaaleng","Nakinomet", "Kaalem", "Kakelae", "Loruth", "Nalita", "Nakapelewoi"], 
"Lapur": ["Natoo", "Nakalale", "Kachoda", "Karebur", "Kokuro", "Meyan"], 
"Lake Zone": ["Namadak", "Lorengippi", "Kataboi", "Lomekwi", "Nachukui", "Riokomor", "Lowarengak", "Todonyang"],
"Kibish": ["Napak", "Lokamarinyang", "Natodomeri", "Kibish", "Kaitede", "Natapar", "Naita"],
"Nakalale":["Naduat", "Lolupe", "Kaenyangaluk", "Losajait","Lokore"],

//Turkana East examples 
"Kapedo/Napeitom": ["Napeitom", "Lomelo", "Kapedo","Nadome", "Kamuge"], 
"Lokori/Kochodin": ["Nakukulas", "Kochodin","Lochakula", "Lokori", "Kangitit", "Lokwii", "Lotubae"], 
"Katilia": ["Lomunyen-Akwaan", "Lopeduru", "Katilia", "Elelea", "Parkati"],

//Turkana South examples 
"Lobokat": [ "Kainuk","Kakongu","Loyapat","Koputiro"], 
"Kaputir": ["Nakwamoru","Lorogon","Kaputir","Kalemwae"],
"Katilu": ["Kalemwae","Kalemngorok","Korinyang","Katilu","Lokapel","Kanaodon"],
"Lokichar": ["Lokichar","Kapese","Kasuroi","Lomunyenkupurat","Lochwaa","Kakalel"],
"Kalapata": ["Loperot","Lomeleku","Kangakipur"],

//Loima subcounty
"Lokiriama/Lorengipi": ["Lorengipi", "Lokiriama", "Nakwapua", "Urum", "Nakurio"],
"Loima": ["Lochor-Ekuyen", "Namoruputh", "Locher-Edome", "Puch"],
"Lobei/Kotaruk": ["Lobei", "Nadapal", "Lokipetot-Arengan", "Kotaruk", "Kangalita"],
"Turkwel": ["Napeikar", "Nadapal", "Turkwel", "Lorugum", "Napeililim", "Kaapus", "Lomeyan"],

//Turkana West
"Kalobeyei": ["Ayanae - Angidapala","Lonyuduk","Nalapatui","Oropoi","Lomunyanakirionok"],
"Kakuma": ["Komudei","Nadapal","Nayenae - Emeyen","Pokotom","Lorengo"],
"Letea": ["Kalimapus","Letea","Loritit","Garite","Loitasonyok","Musug"],
"Lopur": ["Nakoyo","Lochor Edome","Kangitesiroi","Lopusiki","Namon"],
"Songot": ["Lokangai","Atiir","Songot","Lopwarin","Nakururum"]
...
<form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2  gap-2 md:gap-2">
<div>
...
className="form-input w-full border text-[#14213d] border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d]"
...
onChange={handleChange}
className="form-input w-full border border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d]"
...
onChange={handleChange}
className="form-select w-full cursor-pointer border border-gray-300 text-[#14213d] rounded px-3 py-2 focus-within:ring-[#14213d]"
required
>
...
onChange={handleChange}
className="form-select w-full border cursor-pointer border-gray-300 text-[#14213d] rounded px-3 py-2 focus-within:ring-[#14213d]"
required
...
onChange={handleChange}
className="form-radio accent-gray-600 cursor-pointer"
required
/>
...
onChange={handleChange}
className="form-input w-full border border-gray-300 text-[#14213d] rounded px-3 py-2 focus-within:ring-[#14213d]"
...
className="bg-[#14213d] font-bold text-white px-10 py-2 min-w-[100px] md:min-w-[160px] rounded cursor-pointer focus:ring-2 focus:ring-indigo-600 transition duration-200"
>
Next
</button>
</div>
