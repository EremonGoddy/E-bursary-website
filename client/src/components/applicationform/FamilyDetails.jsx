...
className={`${
sidebarActive
? 'inline-block ml-2 xl font-semibold'
: 'hidden'
}`}
>
{item.label}
...
<div className="flex flex-col text-[#14213d] space-y-2 accent-gray-600">
<label className="flex items-center ">
<input type="radio" name="family_status" value="Both parents alive" checked={formData.family_status === "Both parents alive"} onChange={handleChange} className="mr-2 cursor-pointer" />
Both parents alive
</label>
<label className="flex items-center">
<input type="radio" name="family_status" value="Single parent" checked={formData.family_status === "Single parent"} onChange={handleChange} className="mr-2 cursor-pointer" />
Single parent
</label>
<label className="flex items-center">
<input type="radio" name="family_status" value="Orphan" checked={formData.family_status === "Orphan"} onChange={handleChange} className="mr-2 cursor-pointer" />
Orphan
</label>
<label className="flex items-center">
<input type="radio" name="family_status" value="One parent deceased" checked={formData.family_status === "One parent deceased"} onChange={handleChange} className="mr-2 cursor-pointer" />
One parent deceased
</label>
</div>
</div>
...
<div className="flex flex-col space-y-2 text-[#14213d] accent-gray-600">
<label className="flex items-center">
<input type="radio" name="disability" value="Yes" checked={formData.disability === "Yes"} onChange={handleChange} className="mr-2 cursor-pointer" />
Yes
</label>
<label className="flex items-center">
<input type="radio" name="disability" value="No" checked={formData.disability === "No"} onChange={handleChange} className="mr-2 cursor-pointer" />
No
</label>
</div>
</div>
...
<input type="text" id="parentname" name="parentname" value={formData.parentname} onChange={handleChange} className="form-input w-full border border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d]" placeholder="Enter parent/guardian name" />
</div>
<div className='text-[#14213d]'>
<label htmlFor="relationship" className="block font-medium mb-2">Relationship</label>
<input type="text" id="relationship" name="relationship" value={formData.relationship} onChange={handleChange} className="form-input w-full border border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d]" placeholder="Enter relationship" />
</div>
<div className='text-[#14213d]'>
<label htmlFor="contact" className="block font-medium mb-2">Contact Information</label>
<input type="text" id="contact" name="contact" value={formData.contact} onChange={handleChange} className="form-input w-full border border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d]" placeholder="Enter contact information" />
</div>
<div className='text-[#14213d]'>
<label htmlFor="occupation" className="block font-medium mb-2">Occupation</label>
<input type="text" id="occupation" name="occupation" value={formData.occupation} onChange={handleChange} className="form-input w-full border border-gray-300 rounded px-3 py-2  focus-within:ring-[#14213d]" placeholder="Enter occupation" />
</div>
<div className='text-[#14213d]'>
<label htmlFor="guardian" className="block font-medium mb-2">How many children does the guardian have?</label>
<input type="text" id="guardian" name="guardian_children" value={formData.guardian_children} onChange={handleChange} className="form-input w-full border border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d]" placeholder="Enter number of children" />
</div>
<div className='text-[#14213d]'>
<label htmlFor="working" className="block font-medium mb-2">How many siblings are working?</label>
<input type="text" id="working" name="working_siblings" value={formData.working_siblings} onChange={handleChange} className="form-input w-full border border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d]" placeholder="Enter number" />
</div>
<div className='text-[#14213d]'>
<label htmlFor="siblings" className="block font-medium mb-2">How many siblings are studying?</label>
<input type="text" id="siblings" name="studying_siblings" value={formData.studying_siblings} onChange={handleChange} className="form-input w-full border border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d]" placeholder="Enter number" />
</div>
<div className='text-[#14213d]'>
<label htmlFor="income" className="block font-medium mb-2">Monthly Income</label>
<input type="text" id="income" name="monthly_income" value={formData.monthly_income} onChange={handleChange} className="form-input w-full border border-gray-300 rounded px-3 py-2 focus-within:ring-[#14213d] " placeholder="Enter income" />
</div>
</form>
