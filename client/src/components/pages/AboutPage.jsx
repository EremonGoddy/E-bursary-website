      ...
      <div className="py-8 px-4 sm:px-8 mt-[2px] sm:mt-[2px] md:mt-[2px] lg:mt-[2px] xl:mt-[2px]">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
          ...
          <div className="mb-4 p-4 bg-white  rounded-lg shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
            <h2 className="text-[1.3rem] md:text-3xl font-semibold text-gray-800 text-center">Student Registration</h2>
          ...
          <div className=" mb-4 p-4 bg-white  rounded-lg shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
            <h2 className="text-[1.3rem] md:text-3xl font-semibold text-gray-800 text-center">Application Tracking</h2>
            <p className="text-gray-600 mt-4 text-[1rem] md:text-[1.15rem]">
          ...
          {/* Document Upload */}
          <div className="mb-4 p-4 bg-white  rounded-lg shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
            <h2 className="text-[1.3rem] md:text-3xl font-semibold text-gray-800 text-center">Document Upload</h2>
            <p className="text-gray-600 mt-4 text-[1rem] md:text-[1.15rem]">
          ...
          <div className="mb-4 p-4 bg-white  rounded-lg shadow-[0_4px_8px_rgba(0,0,0,0.6)]">
            <h2 className="text-[1.3rem] md:text-3xl font-semibold text-gray-800 text-center">Allocation Notifications</h2>
            <p className="text-gray-600 mt-4 text-[1rem] md:text-[1.15rem]">
