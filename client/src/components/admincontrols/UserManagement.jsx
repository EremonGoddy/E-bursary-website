...
{!sidebarActive && (
<span className="absolute left-full ml-5 top-1/2 -translate-y-1/2 bg-[#14213d] text-white font-semibold px-2 py-1 rounded shadow-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity flex items-center justify-center z-50">
{item.label}
</span>
)}
</li>
...
{/* Main Content */}
<div
className={`flex-1 ml-0 md:ml-64 md:p-4 -mt-8 md:-mt-10 transition-all duration-100 pr-2 pl-2 md:pr-10 md:pl-10
${sidebarActive ? 'ml-[100px] md:ml-[190px]' : 'ml-[0px] md:ml-[10px]'}
`}
>
<h2 className="text-2xl font-bold mb-3 md:mb-6 text-center text-[#14213d]">User Account Management</h2>
...
<h3 className="text-xl font-bold mb-4 text-[#14213d]">Add New User</h3>

<div className="mb-3">
<label htmlFor="fullname" className="block font-medium text-[#14213d] mb-1">
Full Name
</label>
<input
type="text"
...
<div className="mb-3">
<label htmlFor="email" className="block font-medium text-[#14213d] mb-1">
Email
</label>
<input
type="email"
...
<div className="mb-3">
<label htmlFor="role" className="block text-[#14213d] font-medium mb-1">
Role
</label>
<select
id="role"
...
<button
className="bg-[#14213d] hover:bg-gray-700 cursor-pointer text-white px-6 py-2 rounded font-semibold w-full"
...
{/* Activity Logs */}
<div className="max-w-[750px] mb-0 md:mb-4 mt-4 md:mt-0 backdrop-blur-xl bg-white/90 border border-gray-200 shadow-lg rounded-2xl 
