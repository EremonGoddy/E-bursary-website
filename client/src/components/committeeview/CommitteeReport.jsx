...
`}>
<div className="max-w-3xl mx-auto bg-white p-6 shadow-[0_0_10px_3px_rgba(0,0,0,0.25)] rounded-md mt-10">
...
<tbody>
<tr>
<td className="border border-gray-300 px-4 py-2">{studentDetails.reference_number || 'N/A'}</td>
...
{/* Optionally, you can display summary of bursaryInfo and applicationInfo here if desired */}
</div>
</div>
</div>
</div>
