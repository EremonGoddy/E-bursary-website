...
<label className="block font-medium mb-1 w-30 md:w-32 mr-1 md:mr-2">Full name:</label>
<input
type="text"
name="fullname"
className="form-input w-full border rounded px-3 py-1 md:py-2"
...
<div className="mb-3 flex items-center">
<label className="block font-medium mb-1 w-30 md:w-32 mr-1 md:mr-2">Email:</label>
<input
type="email"
name="email"
className="form-input w-full border rounded px-3 py-1 md:py-2"
...
<div className="mb-3 flex items-center">
<label className="block font-medium mb-1 w-30 md:w-32 mr-1 md:mr-2">Phone No:</label>
<input
type="text"
name="phone_no"
className="form-input w-full border rounded px-3 py-1 md:py-2"
...
<div className="mb-3 flex items-center">
<label className="block font-medium mb-1 w-30 md:w-32 mr-1 md:mr-2">National ID:</label>
<input
type="text"
name="national_id"
className="form-input w-full border rounded px-3 py-1 md:py-2"
...
<div className="mb-3 flex items-center">
<label className="block font-medium mb-1 w-30 md:w-32 mr-1 md:mr-2">Sub County:</label>
<input
type="text"
name="subcounty"
className="form-input w-full border rounded  px-3 py-1 md:py-2"
...
<div className="mb-3 flex items-center">
<label className="block font-medium mb-1 w-30 md:w-32 mr-1 md:mr-2">Ward:</label>
<input
type="text"
name="ward"
className="form-input w-full border rounded   px-3 py-1 md:py-2"
...
<div className="mb-3 flex items-center">
<label className="block font-medium mb-1 w-30 md:w-32 mr-1 md:mr-2">Position:</label>
<input
type="text"
name="position"
className="form-input w-full border rounded  px-3 py-1 md:py-2"
