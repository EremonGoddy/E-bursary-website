...
id="currentPassword"
className="form-input w-full border border-gray-300 rounded px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-[#14213d]"
...
/>
<span
className="absolute inset-y-0 right-0 flex text-xl  text-gray-500 items-center pr-3 cursor-pointer"
...
<div className="mb-5">
<label htmlFor="newPassword" className="block mb-1 font-medium text-[#14213d]">
New Password
</label>
<div className="relative">
<input
...
/>
<span
className="absolute inset-y-0 right-0 flex items-center text-gray-500 text-xl pr-3 cursor-pointer"
...
<div className="mb-5">
<label htmlFor="confirmPassword" className="block mb-1 font-medium text-[#14213d]">
...
id="confirmPassword"
className="form-input w-full border rounded border-gray-300 px-3 py-2 pr-10 focus:outline-none focus:ring-2 focus:ring-[#14213d"
...
/>
<span
className="absolute inset-y-0 right-0 text-xl flex items-center text-gray-500 pr-3 cursor-pointer"
...
<button type="submit" className="w-full bg-[#14213d] cursor-pointer text-white rounded py-2 px-4 hover:bg-gray-600 font-semibold">
Update Password
</button>
</form>
{message && (
