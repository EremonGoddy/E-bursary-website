...
return (
<div className="w-full min-h-screen relative bg-gradient-to-br from-blue-50 via-white to-purple-50 p-0 md:p-4">
{/* Top Bar */}
...
{/* Main Content */}
<div className={`flex-1 w-full md:ml-64 p-4 md:p-4 -mt-6 md:-mt-8 transition-all duration-100
${sidebarActive ? 'ml-[0px] md:ml-[190px]' : 'ml-[0px] md:ml-[20px]'}
`}>
...
<h2 className="text-xl text-[#14213d] font-bold text-center mb-0 md:mb-4 text">Bursary Fund Details</h2>
...
transition-all duration-300 transform hover:scale-[1.01] p-3 md:p-3">
<h2 className="text-center text-base text-[#14213d] md:text-xl font-bold mb-2 md:mb-4">Quick Statistics</h2>
