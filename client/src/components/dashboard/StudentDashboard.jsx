...
const sidebarLinks = [
  { to: '/student', icon: faHouse, text: 'Dashboard' },
  { to: '/personaldetails', icon: faFileAlt, text: 'Apply' },
  { to: '/documentupload', icon: faPaperclip, text: 'File attached' },
    ...
    <div className="w-full min-h-screen relative">
      ...
      <div className="bg-white fixed top-0 left-0 w-full shadow-lg p-2 md:p-3 z-50 md:pl-20 md:pr-20">
        <div className="flex justify-between items-center">
          <h1 className="text-2xl sm:text-3xl md:text-3xl font-bold text-[#1F2937]">
            EBursary
          </h1>
          ...
          <ul className="space-y-10 mt-8">
            {sidebarLinks.map(({ to, icon, text }, idx) => (
              ...
              >
                ...
                >
                  <FontAwesomeIcon icon={icon} className="text-[1.2rem] md:text-[1.4rem]" />
                  <span
                    className={`
                      transition-all duration-200 ml-3
                      ${sidebarActive ? 'inline text-[1rem] md:text-[1.1rem]' : 'hidden'}
                    `}
                  >
                    {text}
                  </span>
            ...
            {isStudentRegistered ? (
              ...
              >
                ...
                <p className="block text-[1rem] md:text-[1.1rem]">
                  Please click on the 'Apply' icon in the sidebar to complete your information.
                </p>
              </div>
            )}
          </div>
