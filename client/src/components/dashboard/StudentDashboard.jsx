  ...
  return (
    <div className="w-full min-h-screen relative">
      ...
      <div className="flex pt-20 min-h-screen">
        ...
        {/* Main Content */}
        <main
          className={`flex-1 ml-0 md:ml-64 p-4 -mt-6 md:mt-2 transition-all duration-300 pr-3 pl-3 md:pr-10 md:pl-10
            ${sidebarActive ? 'ml-[180px] md:ml-[190px]' : 'ml-[40px] md:ml-[30px]'}
            min-h-screen
            bg-white
            overflow-x-auto
          `}
