...
const StudentDashboard = () => {
  ...
  // Utility for notification status icon
  ...
  // Sync message read state on mount, and reflect sidebar state
  useEffect(() => {
  ...
  // Check notification message and new/read logic; dashboard reflects last read status
  useEffect(() => {
    const token = sessionStorage.getItem('authToken');
    const userId = sessionStorage.getItem('userId');
    ...
    axios.get(`https://e-bursary-backend.onrender.com/api/status-message/user/${userId}`, {
      ...
      // This ensures that message is read is properly reflected
  ...
  // Ensure the notification dot logic is always up-to-date
  useEffect(() => {
    setHasNewMessage(sessionStorage.getItem('hasNewMessage') === 'true');
  }, []);
      ...
      <div className="bg-white fixed top-0 left-0 w-full shadow-lg p-2 md:p-2.5 z-50 md:pl-20 md:pr-20">
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-1">
            <h2 className="text-sm md:text-lg mr-1 md:mr-5 font-bold text-[#14213d]">
              Welcome: {userName}
            </h2>
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="flex flex-col gap-1 md:gap-4">
                  ...
                  <div className=" p-4  flex flex-col items-center mb-2  backdrop-blur-xl bg-white/80 border border-gray-300 shadow-xl rounded-2xl transition-all duration-300 transform hover:scale-[1.01]">
                    <h2 className="text-[#14213d]  font-bold mb-1">
                ...
                <div className="text-center space-y-2">
                  ...
                  <p className=" text-[#14213d]">
                    ...
                    <span className="font-semibold text-[#14213d]">
                      'Apply'
                      <FontAwesomeIcon icon={faFileAlt} className="text-[#14213d]" />
                    </span>{' '}
                    icon in the sidebar to complete your information.
                  </p>
                </div>
              </div>
            )}
