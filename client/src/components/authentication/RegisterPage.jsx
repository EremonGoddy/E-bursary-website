...
position: "top-center",
icon: <FontAwesomeIcon icon={faCircleExclamation} style={{ color: '#ffff' }} />,
});
return;
}
...
<FontAwesomeIcon icon={faUser} className="text-[#14213d] text-lg mr-2" />
<input
type="text"
...
<div className="flex items-center border border-gray-300 rounded-lg px-3 focus-within:ring-2 focus-within:ring-[#14213d]">
<FontAwesomeIcon icon={faPhone} className="text-[#14213d] text-lg mr-2" />
<input
type="text"
className="w-full py-2 focus:outline-none"
...
<div className="flex items-center border border-gray-300 rounded-lg px-3 focus-within:ring-2 focus-within:ring-[#14213d]">
<FontAwesomeIcon icon={faLock} className="text-[#14213d] text-lg mr-2" />
<input
...
/>
<span
className="ml-2 text-lg text-[#14213d] cursor-pointer"
...
/>
<label htmlFor="terms" className="ml-2 text-[#14213d]">
...
<button
type="submit"
className="text-white w-full font-bold py-2 cursor-pointer rounded-lg bg-[#14213d] hover:bg-gray-700  focus:ring-2 focus:ring-indigo-600"
>
Register
</button>
...
<ToastContainer containerId="loginToast" position="top-center" autoClose={4000}/>
</div>
</div>
);
};
